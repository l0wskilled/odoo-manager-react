...
class Translation {
    ...
    translateMessage(apiMessage) {
        let arrMessages = apiMessage.split(".");
        if (arrMessages.length === 2) {
            return this.translation[arrMessages[0]][arrMessages[1]];
        }
        return this.translation.common.THERE_HAS_BEEN_AN_ERROR;
    }
}
